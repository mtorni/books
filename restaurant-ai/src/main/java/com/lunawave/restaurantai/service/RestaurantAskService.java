...
@Service
public class RestaurantAskService {
    ...
    public RestaurantAskService(ChatClient.Builder chatClientBuilder, VectorStore vectorStore) {
        this.chatClient = chatClientBuilder.build();
        this.vectorStore = vectorStore;
    }

    public String answer(String question, String restaurantId) {
